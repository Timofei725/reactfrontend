...
e.preventDefault();
await axios.put(`api/admin/users/${id}`,user, { headers })
navigate("/apiadminusers")
    };
    
   const loadUser=async()=>{
        const result=await axios.get(`api/admin/users/${id}`, { headers })
        setUser(result.data)
    }
...
<h2 className="text-center m-4">Редактировать данные пользователя</h2>
